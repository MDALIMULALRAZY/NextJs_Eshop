                            ...
                            <div className="tt-product-single-info">
                                <div className="tt-add-info">
                                    <ul>
                                        ...
                                        <li>
                                            <span>
                                                DISPONIBILITE: {productStock === cartProductQuantity ? 'Stock épuisé' : `${productStock - cartProductQuantity} en Stock`}
                                            </span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="tt-price">
                                    <span className="new-price">{productPrice.toFixed(2) + CURRENCY }</span>
                                ...
                                <div className="tt-wrapper">
                                    <div className="tt-row-custom-01">
                                        ...
                                        <div className="col-item">
                                            ...
                                            >
                                                {productStock === cartProductQuantity ? "VENDU" : (
                                                    <><i className="icon-f-39"/> AJOUTER AU PANIER</>
                                                )}
                                            </button>
                                        </div>
                                    </div>
