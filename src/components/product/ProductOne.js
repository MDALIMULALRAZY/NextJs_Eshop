                    ...
                    <Link href={slug}>
                        <a>
                            ...
                            <div className="tt-label-location">
                                ...
                                {!productStock && <span className={`tt-label-out-stock`}>Stock épuisé</span>}
                            </div>
                        </a>
                    </Link>
                </div>
                            ...
                            <button
                                ...
                                onClick={() => {
                                    ...
                                    !isInCart ? modalCartAddedHandler() : cogoToast.success(
                                        `Votre sélection "${product.name}" est déjà dans le panier.`, {
                                            position: "bottom-right",
                                            heading: "Dans le panier!",
                                            hideAfter: 4
                                        }
                                    );
                                }}
                            >
                                {productStock === cartProductQuantity ? "VENDU" : "AJOOUTER AU PANIER"}
                            </button>
                        </div>
